...
public class Spawner : MonoBehaviour
{
    ...
    void Spawn()
    {
        GameObject enemy = GameManager.instance.pool.Get(0); // enemy 1개만 들어있음, enemy를 소환
        ...
        enemy.GetComponent<Enemy>().Init(spawnData[4]); // 0레벨이면 0몬스터 정보값 4개 불러옴, 1레벨이면 1몬스터 정보값
